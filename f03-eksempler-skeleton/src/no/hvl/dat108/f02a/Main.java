...
public class Main {
	...
	public static void main(String[] args) {
		...
		Boblesortering.sorter(listeAvPersoner, (a, b) -> a.getFornavn().compareTo(b.getFornavn()));
		System.out.println("Sortert på fornavn:   " + listeAvPersoner);

		//5. Ønsker å sortere på fødselsår. Hva gjør vi?
		Boblesortering.sorter(listeAvPersoner, (a, b) -> a.getFodselsaar() - b.getFodselsaar());
